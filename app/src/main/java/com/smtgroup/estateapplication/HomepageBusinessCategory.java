...
public class HomepageBusinessCategory extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listBusiness.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                Log.e("hpbc adcategory", AdPage.adCategory);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_house) {
            ...
            AdPage.adCategory = "";
            Intent i = new Intent(HomepageBusinessCategory.this,AdPage.class);
            startActivity(i);
            ...
            if (editor.remove("userEmail").commit() && editor.remove("userPass").commit()){
                Intent intent = new Intent(HomepageBusinessCategory.this, SignIn.class);
                startActivity(intent);
                HomepageBusinessCategory.this.finish();
            }
        }
